...
import img01 from "../../../public/company/logoChivo.png"
...
export default function Header() {
   ...
   return (
      <div className="w-full fixed z-50 top-0 left-0   bg-amber-50">
         <div className="md:hidden w-full h-20 flex flex-row relative">
            <div className="w-[calc(100%-60px)] h-20 flex justify-start items-center" >
               <Image
                  className="ml-4"
                  src={img01}
                  width={172}
