    	...
    	<div className="w-full  bg_01 bg-cover bg-center  flex flex-col   justify-center items-center sm:py-10  xl:py-10 ">
         ...
         <div className="w-full flex flex-col px-10 md:px-0 text-amber-50 SunMore text-3xl  max-w-[660px]">
            ...
            <div className="w-full flex flex-col md:flex-row md:justify-between">
               <a target="_blank" href="" className="w-full md:w-[300px] h-32 border-4 border-amber-50 rounded-3xl mb-8 flex justify-center items-center cursor-pointer">
                  {textBtn1}
               </a>
            ...
            <a target="_blank" href="" className="w-full h-32 border-4 border-amber-50 rounded-3xl mb-8 flex justify-center items-center cursor-pointer">
                  {textBtn3}
            </a>
         </div>
